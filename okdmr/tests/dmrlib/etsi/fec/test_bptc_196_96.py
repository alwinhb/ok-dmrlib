...
def test_decode_encode():
    ...
    for hex_burst in hex_bursts:
        ...
        my_data_deepak = ("010000100100100101010010010101000100100001000100010000010101100111001010100001000010001111101001")
        ...
        encoded_full: bitarray = BPTC19696.encode(
           bits_deinterleaved=BPTC19696.deinterleave_all_bits(burst.inbits)
            )
        print ("NEW")
        print (encoded_full)
        print ("AFTER")
